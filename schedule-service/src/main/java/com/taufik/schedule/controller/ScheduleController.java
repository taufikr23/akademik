...
public class ScheduleController {
    ...
    public ResponseEntity<ApiResponse<ScheduleResponse>> createSchedule(
        ...
        log.info("POST /api/v1/schedules - Create schedule");
    ...
    public ResponseEntity<ApiResponse<List<ScheduleResponse>>> getAllSchedules() {
        log.info("GET /api/v1/schedules - Get all schedules");
    ...
    public ResponseEntity<ApiResponse<List<ScheduleResponse>>> getSchedulesByClass(
        ...
        log.info("GET /api/v1/schedules/class/{} - Get schedules by class", classId);
    ...
    public ResponseEntity<ApiResponse<List<ScheduleResponse>>> getSchedulesByTeacher(
        ...
        log.info("GET /api/v1/schedules/teacher/{} - Get schedules by teacher", teacherId);
    ...
    public ResponseEntity<ApiResponse<List<ScheduleResponse>>> getSchedulesByClassAndDay(
        ...
        log.info("GET /api/v1/schedules/class/{}/day/{} - Get schedules", classId, dayOfWeek);
    ...
    public ResponseEntity<ApiResponse<ScheduleResponse>> getScheduleById(
        ...
        log.info("GET /api/v1/schedules/{} - Get schedule by id", id);
    ...
    public ResponseEntity<ApiResponse<ScheduleResponse>> updateSchedule(
            @PathVariable Long id,
            @Valid @RequestBody ScheduleRequest request) {
        log.info("PUT /api/v1/schedules/{} - Update schedule", id);
    ...
    public ResponseEntity<ApiResponse<Void>> deleteSchedule(
            @PathVariable Long id) {
        log.info("DELETE /api/v1/schedules/{} - Delete schedule", id);
