...
public class SubjectController {
    ...
    public ResponseEntity<ApiResponse<SubjectResponse>> createSubject(
        ...
        log.info("POST /api/v1/subjects - Create subject: {}", request.getCode());
    ...
    public ResponseEntity<ApiResponse<List<SubjectResponse>>> getAllSubjects() {
        log.info("GET /api/v1/subjects - Get all subjects");
    ...
    public ResponseEntity<ApiResponse<List<SubjectResponse>>> getActiveSubjects() {
        log.info("GET /api/v1/subjects/active - Get active subjects");
    ...
    public ResponseEntity<ApiResponse<SubjectResponse>> getSubjectById(
        ...
        log.info("GET /api/v1/subjects/{} - Get subject by id", id);
    ...
    public ResponseEntity<ApiResponse<SubjectResponse>> getSubjectByCode(
        ...
        log.info("GET /api/v1/subjects/code/{} - Get subject by code", code);
    ...
    public ResponseEntity<ApiResponse<SubjectResponse>> updateSubject(
            @PathVariable Long id,
            @Valid @RequestBody SubjectRequest request) {
        log.info("PUT /api/v1/subjects/{} - Update subject", id);
    ...
    public ResponseEntity<ApiResponse<Void>> deleteSubject(
            @PathVariable Long id) {
        log.info("DELETE /api/v1/subjects/{} - Delete subject", id);
