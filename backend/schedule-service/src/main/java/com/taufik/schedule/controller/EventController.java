...
public class EventController {
    ...
    public ResponseEntity<ApiResponse<EventResponse>> createEvent(
        ...
        log.info("POST /api/events - Create event: {}", request.getTitle());
    ...
    public ResponseEntity<ApiResponse<List<EventResponse>>> getAllEvents() {
        log.info("GET /api/events - Get all events");
    ...
    public ResponseEntity<ApiResponse<List<EventResponse>>> getActiveEvents() {
        log.info("GET /api/events/active - Get active events");
    ...
    public ResponseEntity<ApiResponse<List<EventResponse>>> getEventsByType(
        ...
        log.info("GET /api/events/type/{} - Get events by type", eventType);
    ...
    public ResponseEntity<ApiResponse<List<EventResponse>>> getEventsInDateRange(
        ...
        log.info("GET /api/events/range - Get events between {} and {}", start, end);
        return ResponseEntity.ok(ApiResponse.success(eventService.getEventsInDateRange(start, end)));
    }

    @GetMapping("/upcoming")
    public ResponseEntity<ApiResponse<List<EventResponse>>> getUpcomingEvents() {
        log.info("GET /api/events/upcoming - Get upcoming events");
    ...
    public ResponseEntity<ApiResponse<EventResponse>> getEventById(
        ...
        log.info("GET /api/events/{} - Get event by id", id);
    ...
    public ResponseEntity<ApiResponse<EventResponse>> updateEvent(
            @PathVariable Long id,
            @Valid @RequestBody EventRequest request) {
        log.info("PUT /api/events/{} - Update event", id);
    ...
    public ResponseEntity<ApiResponse<Void>> deleteEvent(
            @PathVariable Long id) {
        log.info("DELETE /api/events/{} - Delete event", id);
