...
public class StudentController {
    ...
    public ResponseEntity<ApiResponse<StudentResponse>> createStudent(
        ...
        log.info("POST /api/students - Create student: {}", request.getNis());
    ...
    public ResponseEntity<ApiResponse<List<StudentResponse>>> getActiveStudents() {
        log.info("GET /api/students/active - Get active students");
    ...
    public ResponseEntity<ApiResponse<StudentResponse>> getStudentByNis(
        ...
        log.info("GET /api/students/nis/{} - Get student by NIS", nis);
