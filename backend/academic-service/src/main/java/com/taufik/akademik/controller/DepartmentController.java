...
public class DepartmentController {
    ...
    public ResponseEntity<ApiResponse<DepartmentResponse>> createDepartment(
        ...
        log.info("POST /api/departments - Create department: {}", request.getCode());
    ...
    public ResponseEntity<ApiResponse<List<DepartmentResponse>>> getActiveDepartments() {
        log.info("GET /api/departments/active - Get active departments");
    ...
    public ResponseEntity<ApiResponse<DepartmentResponse>> getDepartmentByCode(
        ...
        log.info("GET /api/departments/code/{} - Get department by code", code);
