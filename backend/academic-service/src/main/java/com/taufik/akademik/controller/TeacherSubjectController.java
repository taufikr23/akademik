...
public class TeacherSubjectController {
    ...
    public ResponseEntity<ApiResponse<TeacherSubjectResponse>> assignTeacherToSubject(
        ...
        log.info("POST /api/teacher-subjects - Assign teacher to subject");
    ...
    public ResponseEntity<ApiResponse<List<TeacherSubjectResponse>>> getAllAssignments() {
        log.info("GET /api/teacher-subjects - Get all assignments");
    ...
    public ResponseEntity<ApiResponse<List<TeacherSubjectResponse>>> getAssignmentsByTeacher(
        ...
        log.info("GET /api/teacher-subjects/teacher/{} - Get assignments by teacher", teacherId);
    ...
    public ResponseEntity<ApiResponse<List<TeacherSubjectResponse>>> getAssignmentsBySubject(
        ...
        log.info("GET /api/teacher-subjects/subject/{} - Get assignments by subject", subjectId);
        return ResponseEntity.ok(ApiResponse.success(teacherSubjectService.getAssignmentsBySubject(subjectId)));
    }

    @GetMapping("/class/{classId}")
    public ResponseEntity<ApiResponse<List<TeacherSubjectResponse>>> getAssignmentsByClass(
            @PathVariable Long classId) {
        log.info("GET /api/teacher-subjects/class/{} - Get assignments by class", classId);
        return ResponseEntity.ok(ApiResponse.success(teacherSubjectService.getAssignmentsByClass(classId)));
    }

    @GetMapping("/academic-year/{academicYearId}")
    public ResponseEntity<ApiResponse<List<TeacherSubjectResponse>>> getAssignmentsByAcademicYear(
            @PathVariable Long academicYearId) {
        log.info("GET /api/teacher-subjects/academic-year/{} - Get assignments by academic year", academicYearId);
    ...
    public ResponseEntity<ApiResponse<TeacherSubjectResponse>> getAssignmentById(
        ...
        log.info("GET /api/teacher-subjects/{} - Get assignment by id", id);
    ...
    public ResponseEntity<ApiResponse<Void>> removeAssignment(
            @PathVariable Long id) {
        log.info("DELETE /api/teacher-subjects/{} - Remove assignment", id);
